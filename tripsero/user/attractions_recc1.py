...
class Util(object):
    ...
    def read_data(self, folder):
        ...
        folder = '/home/arppit/Documents/Varun/tripsero/tripsero/etl/'
...
def filter_df(filename, user, low, high, province, att_df):
    ...
    url = pd.read_json('/home/arppit/Documents/Varun/tripsero/tripsero/ml_scripts/outputs/attractions_cat.json',orient='records')
    url['id'] = url.index
