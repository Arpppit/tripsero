...
def survey(request):
    if request.method == "POST":
        ...
        #print(user_info)
        recommendation =feed_input(100, 990, 'british_columbia', 4, {'Food Wine & Nightlife': 4, 'Luxury & Special Occassion': 5, 'Water Sports': 4, 'Walking/Cycling & biking': 5, 'Shows Concerts & Sports': 2})
        #print(user_info['low'],user_info['high'],user_info['location'],user_info['days'],user_info['cat_rating'])
