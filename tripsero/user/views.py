...
def survey(request):
    if request.method == "POST":
        ...
        print(user_info)
        #recommendation = feed_input(300, 990, 'british_columbia', 2, {
        #                           'Food Wine & Nightlife': 4, 'Luxury & Special Occassion': 5, 'Water Sports': 4, 'Walking/Cycling & biking': 5, 'Shows Concerts & Sports': 2})
